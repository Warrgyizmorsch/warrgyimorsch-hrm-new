<ul class="nav zoho-form-tabs" id="employeeDetailTab" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="bank-tab" type="button" data-bs-toggle="tab" data-bs-target="#bank"
            role="tab" aria-controls="bank" aria-selected="false">
            <i class="bi bi-bank"></i> Bank Details
        </button>
    </li>
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="salary-tab" type="button" data-bs-toggle="tab" data-bs-target="#salary"
            role="tab" aria-controls="salary" aria-selected="false">
            <i class="bi bi-cash-coin"></i> Salary Package
        </button>
    </li>
    <li class="nav-item" role="presentation">
